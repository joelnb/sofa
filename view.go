...
func (v TemporaryView) Execute(opts Options) (DocumentList, error) {
...
func (v NamedView) Execute(opts Options) (DocumentList, error) {
	path := fmt.Sprintf("_design/%s/view/%s", v.DesignDoc, v.Name)
